...
/*------------------------------------------*/
// Modify to enable run time stats
#define configUSE_TRACE_FACILITY	    1  // Set to 1 when using run time stats
// Uncomment the following to turn on runtime stats
#define configGENERATE_RUN_TIME_STATS   1
#define configUSE_STATS_FORMATTING_FUNCTIONS 1
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() xconfigTimerForRunTimeStats()
#define portGET_RUN_TIME_COUNTER_VALUE() TCNT1   // timer 1, 16 microSec tick, see runtTimeStatsTimer.c for details on time scale
/*------------------------------------------*/
...
// Configuration additions - G. Arbez
//#define configUSE_MALLOC_FAILED_HOOK			1    // Used to check use of external memory for heap (not available on Stingray robot Aduino Mega
