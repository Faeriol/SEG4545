...
uint8_t spiSelect (SPI_SLAVE_SELECT SS_pin) __attribute__ ((hot));
void spiDeselect (SPI_SLAVE_SELECT SS_pin) __attribute__ ((hot));
...
uint8_t spiTransfer(uint8_t data) __attribute__ ((hot));

uint8_t spiMultiByteTx(const uint8_t *data, const uint16_t length) __attribute__ ((hot));
uint8_t spiMultiByteTx_P(const uint8_t *data, const uint16_t length) __attribute__ ((hot)); // send from flash. Used in Gameduino2
uint8_t spiMultiByteRx(uint8_t *data, const uint16_t length) __attribute__ ((hot));

uint8_t spiMultiByteTransfer(uint8_t *data, const uint16_t length) __attribute__ ((hot));
