 ...
 ******************************************************************/
typedef enum {
  USART0_ID = 0,   //!< identifier for USART0
  USART1_ID = 1,   //!< identifier for USART1
  USART2_ID = 2,   //!< identifier for USART2
  USART3_ID = 3    //!< identifier for USART3
} USART_ID;
